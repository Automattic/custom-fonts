...
class Jetpack_Fonts_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'fonts-customizer', plugins_url( 'css/fonts-customizer.css', __FILE__ ), array(), '20220804' );
		wp_register_script( 'webfonts', plugins_url( 'js/webfont.js', __FILE__ ), array(), '20140204', true );
		wp_enqueue_script( 'jetpack-fonts', plugins_url( 'js/jetpack-fonts.js', __FILE__ ), array( 'customize-controls', 'backbone', 'webfonts' ), '20220804', true );
		$data = array(
